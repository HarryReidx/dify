              ...
              <div className='w-full'>
                ...
                <p className={cn('body-xs-regular pb-0.5 text-text-tertiary')}>
                  <Trans
                    ...
                    components={{ privacyPolicyLink: <Link href={'https://tsingyun.yuque.com/yg70ks/pd1szw/awlc7dl1z53shcpx'} target='_blank' rel='noopener noreferrer' className='text-text-accent' /> }}
                  />
                </p>
                <Input
                  className='mt-1'
