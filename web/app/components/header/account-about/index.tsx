      ...
      <div className='relative'>
        ...
        <div className='flex flex-col items-center gap-4 py-8'>
          ...
          <div className='flex flex-col items-center gap-2 text-center text-xs font-normal text-text-secondary'>
            ...
            {/*      : <> */}
            {/*        <Link href='https://tsingyun.yuque.com/yg70ks/pd1szw/awlc7dl1z53shcpx' target='_blank' rel='noopener noreferrer'>Privacy Policy</Link>,&nbsp; */}
            {/*        <Link href='https://tsingyun.yuque.com/yg70ks/pd1szw/awlc7dl1z53shcpx' target='_blank' rel='noopener noreferrer'>Terms of Service</Link> */}
            {/*      </> */}
            {/*  } */}
            {/* </div> */}
          </div>
